...
account_id      = os.environ['216868'] # no default here, just throw an error here if id not provided
project_id      = os.environ['314276'] # no default here, just throw an error here if id not provided
job_id          = os.environ['457263'] # no default here, just throw an error here if id not provided